            ...
            <div className="row align-items-center">
              <div className="col-lg-6 col-md-12 col-sm-12 content-left">
                ...
                <p>
                  ...
                  focused on delivering an audience inspired approach to
                  knowledge generation and intelligence provision. Through the
                  Building family of products and services, our community reach
                  now extends across digital, print and live
                </p>
                <div className="mt-5 pb-3">
                  <img
                    className="img-fluid"
                    src="/assets/imagewebp/ourteam/img_text.webp"
                    alt=""
                  />
                </div>
              </div>
              <div className="col-lg-6 col-md-12 col-sm-12">
                <img
                  className="img-fluid"
                  src="/assets/imagewebp/ourteam/img_1.webp"
                  alt=""
                />
              </div>
            </div>
                      ...
                      <div className="featured-box-wrap">
                        ...
                        <div className="featured-box-bottom">
                          <p className="featured-box-description">
                            We design and service the next generation office
                            building – one that feels more like a full-service,
                            lifestyle hotel
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div className="featured-box">
                      <div className="featured-box-wrap">
                        ...
                        <div className="featured-box-bottom">
                          <p className="featured-box-description">
                            By studying the science of catering to large groups
                            of people, particularly in a business context
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            <div className="container">
              ...
              <div className="row no-gutters">
                <div className="col-lg-3 col-md-6 col-sm-6">
                  <OurTeamBlock
                    img="/assets/imagewebp/about/team_1.webp"
                    name={`Connor Flores`}
                    job={`JV PROPERTY MANAGEMENT`}
                    position={`top`}
                  >
                ...
                <div className="col-lg-3 col-md-6 col-sm-6">
                  <OurTeamBlock
                    img="/assets/imagewebp/about/team_2.webp"
                ...
                <div className="col-lg-3 col-md-6 col-sm-6">
                  <OurTeamBlock
                    img="/assets/imagewebp/about/team_3.webp"
                    name={`WILLIE TODD`}
                ...
                <div className="col-lg-3 col-md-6 col-sm-6">
                  <OurTeamBlock
                    img="/assets/imagewebp/about/team_4.webp"
                    name={`JOSIE MAXWELL`}
            ...
            <div className="row align-items-center pb-5">
              ...
              <div className="col-lg-6 col-md-12 col-sm-12 content-right">
                ...
                <p>
                  ...
                  knowledge generation and intelligence provision. Through the
                  Building family of products and services, our community reach
                  now extends across digital, print and live platforms, and as a
                  result we’re more than just a media provider; we’re an
                  influential hub for world-class thought leadership and
                  innovation.
                </p>
              </div>
            </div>
