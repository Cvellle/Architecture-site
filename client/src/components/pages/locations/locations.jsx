            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-6 col-md-12 col-sm-12 content-right">
                ...
                <p className="text-black">
                  ...
                  kojih su dva parking mesta za invalide. OBJEKAT je spratnosti
                  Po+Pr+4sp+Pk(Ps). Objekat je planiran sa stanovima različitih
                  struktura od garsonjera do četvorosobnih stanova i različitih
                  površina od 27,44m² do 107,20m². U objektu je planiran stan
                  prilagođen osobama sa posebnim potrebama. U zgradi postoji dva
                  putnička lifta.
                </p>
              </div>
            </div>
